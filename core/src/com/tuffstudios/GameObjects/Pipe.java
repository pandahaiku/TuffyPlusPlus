...
PIPE CLASS
The Pipe class is an extension off the scrollable class because it moves across
the screen from right to left. This class defines all the variables related
to the pipes which include the height and distance between them. It also handles
collisions with the elephant.
...
public class Pipe extends Scrollable {
	...
	//vertical_gap is the distance between the top and bottom pipes
	...
	//THis function handles the collision between elephant and pipes
